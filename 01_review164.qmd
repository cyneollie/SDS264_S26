...
vaccine_data |>
  mutate(HHincome_vs_national = ifelse(median_HHincome_2019 < 69560, "low", "high")) |>
  mutate(region_sort = fct_relevel(region, median_HHincome_2019)) |>
...
median_HHincome_2019 < 69560 is a logical statement, producing TRUE/FALSE
