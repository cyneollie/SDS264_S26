...
omdb_api_key <- readLines("~/SDS264_S26/Classwork/omdb_api_key.txt")
```
...
for(i in 1:5) {
  ...
  omdb[i,6] <- details$IMD  # imdb rating (be sure it is numeric)
  omdb[i,7] <- details$  # box office (be sure it is numeric)
}
